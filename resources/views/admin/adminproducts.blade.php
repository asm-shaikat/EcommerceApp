            ...
            <div class="fform container">
                <form action="/addproducts" method="post" enctype="multipart/form-data">
                    ...
                    <div class="marginn"><label for="Product">Product Title:</label>
                        <input type="text" name="title" class="form-control " placeholder="Enter products title" style="color: red;">
                    </div>

                    <div class="marginn"><label for="Price">Product's price:</label>
                        <input type="number" name="price" class="form-control" placeholder="Enter products price" style="color: red;">
                    </div>

                    <div class="marginn"><label for="Amount">Products Amount:</label>
                        <input type="number" name="amount" class="form-control" placeholder="Enter products amount" style="color: red;">
                    </div>

                    <div class="marginn"><label for="file">Product's picture</label>
                    ...
                    <div class="marginn"><label for="Description">Products Description</label> 
                        <input type="text" class="form-control" name="description" id="" placeholder="Description" style="color: red;">
                </div>
