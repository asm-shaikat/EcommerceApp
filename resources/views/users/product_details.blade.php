    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            @foreach($data as $data)
                <img src="{{ $data->pictures }}" width="100%" id="ProductImg">
            ...
            <div class="col-2">
                ...
                @csrf
                <input style="margin-right: 20px;width: 200px;" type="number" name="amount" min="1" placeholder="insert a amount" oninput="validity.valid||(value='');" required>
